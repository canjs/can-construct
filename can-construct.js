...
assign(Construct, {
  ...
  _defineProperty: function _defineProperty(what, oldProps, propName, descriptor) {
  ...
  _overwrite: function _overwrite(what, oldProps, propName, val) {
    Object.defineProperty(what, propName, {
      value: val, configurable: true, enumerable: true, writable: true
    });
  },
   ...
   * ```
   */
  setup: function setup(base) {
    this.defaults = deepAssign(true, {
  ...
  extend: function extend(name, staticProperties, instanceProperties) {
    ...
    // Strip semicolons
    //!steal-remove-start
    constructorName = shortName ? shortName.replace(constructorNameRegex, '_') : 'Constructor';
    ...
    /* eslint-enable no-invalid-this, consistent-return */
    ...
    Construct._inherit(klass, _superClass, Constructor);
 ...
 *
 */
Construct.prototype.setup = function setup() {};
/**
